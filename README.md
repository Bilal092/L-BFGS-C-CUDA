...
# Authors
The C-GPU version and Matlab wrapper are written by Tan H. Nguyen, thnguyn2@illinois.edu.

The original C-CPU code and Matlab wrapper are written by Stephen Becker, stephen.becker@colorado.edu
